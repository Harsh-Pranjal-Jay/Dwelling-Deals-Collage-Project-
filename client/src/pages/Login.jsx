...
const Login = () => {
    ...
    useEffect(() => {
        if (currentUser && currentUser.email) {
            if(currentUser.email == "dwellingdeals777@gmail.com" && currentUser.password == "admin1234"){
                navigate('/admin');
                ...
                <div className="w-full lg:w-1/2 p-6 lg:p-12 bg-white">
                    {currentUser && currentUser.email ? (
                        ...
                        <div className='form-section'>
                            ...
                            {isNewUser && (
                                <p className="text-center text-gray-700 mt-4">
                                    <a onClick={handleForgotPasswordClick} className='text-blue-600 font-semibold cursor-pointer'>
                                        Forgot Password?
                                    </a>
                                </p>
                            )}
