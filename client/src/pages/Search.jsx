    ...
    (async () => {
      try {
        ...
        const res = await fetch(
          `/api/posts?searchTerm=${searchTermState}&type=${formState.type}&parking=${formState.parking}&furnished=${formState.furnished}&offer=${formState.offer}&minPrice=${formState.minPrice}&maxPrice=${formState.maxPrice}&page=${pageCount}`
        );
        ...
        if (json.success === false) {
          ...
          setListings(json);
          setListings((prev) =>
            prev.filter((listing) => listing.status === "Verified")
          );
          setLoading(false);
        }
      } catch (error) {
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="feilds_cotainer mt-4">
                    <div className="feilds max-w-xs">
                      ...
                      {/* Adding Price Range */}
                      <div className="price_container mt-5">
                        <p className="text-lg font-heading">Price Range:</p>
                        <div className="flex items-center mt-2">
                          <input
                            type="number"
                            placeholder="Min Price"
                            className="price_input h-8 w-[7rem] text-center bg-white border border-black"
                    ...
                    <>
                      ...
                      <div className="pageination_part mt-8 md:mt-14 w-full flex items-center justify-center">
                        <div className="join">
                          ...
                          <button className="join-item btn bg-brand-blue hover:bg-brand-blue cursor-default text-white">
                            Page {pageCount}
                          </button>
