        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {status == "pending" && <div className="absolute top-3 right-3 inline-flex items-center rounded-sm bg-gray-500  px-2 py-1 shadow-md">
                        <span className="text-white uppercase font-heading">    
                            {status}
                        </span>
                    </div>}
                    {status == "Verified" && <div className="absolute top-3 right-3 inline-flex items-center rounded-sm bg-green-700  px-2 py-1 shadow-md">
                        <span className="text-white uppercase font-heading">    
                            {status}
                        </span>
                    </div>}
                    {status == "Rejected" && <div className="absolute top-3 right-3 inline-flex items-center rounded-sm bg-red-700  px-2 py-1 shadow-md">
                        <span className="text-white uppercase font-heading">    
                            {status}
                        </span>
                    </div>}
