        ...
        <div className="listing_card bg-white shadow-lg shadow-black/10  hover:shadow-brand-blue/20 rounded-sm w-full hover:shadow-lg group sm:mr-auto sm:ml-0 mx-auto">
            <div className="card-container">
                ...
                <div className="card_body group-hover:bg-brand-blue/5 duration-500  border-x border-b border-brand-blue/20 ">
                    ...
                    <div className="listing_footer grid grid-cols-2 items-center border-t border-brand-blue/40 mt-4 p-3">
                        <div className="price_container">
                            {offer && discountPrice ? (
                                <div className="space-y-1">
                                    <p className='text-sm font-content text-gray-400 line-through'>
                                        Rs.{price}
                                    </p>
                                    <p className='text-lg font-content text-brand-blue font-bold'>
                                        Rs.{discountPrice}
                                    </p>
                                </div>
                            ) : (
                        ...
                        <div className="footer_btn flex items-center justify-end">
                            <button
                                onClick={() => handleSaveListings(_id)}
                                className={`text-xl drop-shadow-sm duration-300 ${heart ? 'text-brand-blue' : "text-gray-300"}`}>
                                <FaBookmark />
                            </button>
                        </div>
                    </div>
