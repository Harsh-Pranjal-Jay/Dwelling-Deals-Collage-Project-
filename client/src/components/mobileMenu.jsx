import { FaBookmark, FaHome, FaSignInAlt, FaSignOutAlt, FaUser, FaUsers, FaPlus } from 'react-icons/fa';
...
const MobileMenu = ({ menuStatus }) => {
    ...
    return (
        <menu className='absolute right-0 bg-white h-72 py-5 px-5 text-brand-blue font-semibold w-full !z-50 shadow-lg shadow-brand-blue/40'>
            <ul>
                <li
                    onClick={() => {
                        navigate('/home'),
                    ...
                    currentUser && currentUser.email
                        ...
                        <>
                            ...
                            {currentUser.role === 'seller' && (
                                ...
                                >
                                    <p className='flex items-center gap-2'>
                                        <FaPlus className='text-blue-600' /> Create Post
                                    </p>
                                </li>
                            )}
                            <li
