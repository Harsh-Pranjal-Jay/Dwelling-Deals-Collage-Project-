...
const OfferedListing = () => {
  ...
  return (
    <section className="bg-gray-200">
      <div className="mx-auto max-w-screen-xl bg-gray-200 space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="content">
          <h2 className="text-3xl font-bold sm:text-5xl font-heading  text-brand-blue sm:text-left ">
            Unlock The Exclusive{" "}
            <span className=" text-blue-700 px-1 pb-1">Discounts !</span>
          </h2>
          <p className="font-content  font-medium text-sm sm:text-lg mt-4 max-w-3xl">
            Elevate your living experience with our exceptional offers on both
